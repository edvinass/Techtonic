...
export const AGES: Record<AgeId, AgeDef> = {
  ...
  metal: {
    ...
    landmark: "factory",
    minPopulation: 45,
    cost: { food: 150, wood: 110, stone: 95, metal: 160, knowledge: 60 },
  },
  industrial: {
    id: "industrial",
    name: "Industrial Age",
    ...
    landmark: "reactor",
    minPopulation: 58,
    cost: { food: 170, wood: 90, stone: 120, metal: 220, knowledge: 130 },
  },
  atomic: {
    id: "atomic",
    name: "Atomic Age",
    ...
    landmark: "launch_pad",
    minPopulation: 72,
    cost: { food: 200, stone: 110, metal: 300, knowledge: 240 },
  },
  space: {
    id: "space",
    name: "Space Age",
